namespace SysHv.Client.WinService
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // serviceInstaller
            // 
            this.serviceInstaller.ServiceName = "SysHvMonitoringService";
            this.serviceInstaller.Description = "SysHv service that monitors computer data and sends it to the server";
